                      ...
                      return Column(
                        ...
                        children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  Text(Utils.getFormatNumber(
                                      _movieDetailController.movie.voteCount)),
                                ],
                              )
                            ],
                          ),
                          RatingBar(
                            ...
                            itemSize: 18,
                            initialRating:
                                _movieDetailController.movie.voteAverage! / 2,
                          ...
                          Visibility(
                            visible:_movieDetailController.movie.homepage.isNotEmpty,
                            child: TextButton(
                              style: ButtonStyle(
                          ...
                          CustomButton(title: "Abrir no IMDB", onPressed: ()async {
                          ...
                          SizedBox(height: CustomValues.paddingBorder,)
                        ],
                      );
                    }),
              ),
